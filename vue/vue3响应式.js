...
// computed注意的点
// 1.lazy 计算 effect 的 lazy options决定
// 2.缓存值，在 scheduler 函数的执行后将 dirty 变成 true 重新计算取值
...
const obj = new Proxy(data, {
    get(target, key, receiver){
        ...
        // const data = { // 实际调用get的时候 this 是原始对象 data 而不是 代理对象obj
        //     foo: 1,
        //     get bar(){
        //         return this.foo
        //     }
    ...
    set(target, key, newVal,receiver){
        ...
        // })
        // child.bar = 2
        // 对于继承对象访问本身的属性值并且新旧值有变化才会执行trigger方法，避免触发两次依赖更新和effect的执行
